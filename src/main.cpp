...
const string strMessageMagic = "Unattainium Signed Message:\n";
...
static const int64 nTargetSpacing = 9000;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000692c5ed1da2f480cd8d6aa6aa6b16deff49c26bf5a773120328b8b12");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1405002383;
        block.nBits    = 486604799;
        block.nNonce   = 231373351;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UnattainiumMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UnattainiumMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("UnattainiumMiner started\n");
    ...
    try { loop {
        ...
        printf("Running UnattainiumMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("UnattainiumMiner terminated\n");
        throw;
    }
}
